...
```bash
nano ~/mindctl/helpers/thread_agent.c
```
...
```bash
gcc ~/mindctl/helpers/thread_agent.c -o ~/mindctl/helpers/thread_agent -lpthread
```

---

On passe à l'explication ou aux scripts Obsidian des deux fichiers C ?